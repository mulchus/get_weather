...
class EnvSettings(BaseSettings):
    ...
    WEATHER_API_KEY: str
    """API key to access weather service. See https://openweathermap.org/api/one-call-3#start for details."""

    WEATHER_API_URL: AnyHttpUrlString = 'http://api.openweathermap.org/data/2.5/weather'
    """URL to whether service API."""
